...
$("#select-service-proactive").on('click', function(ev){
    ...
    if ($('#select-service-proactive').val() == "Служебный"){
        ...
        $('#ser-proac-forms').replaceWith(
            '<div class="mt-3" id="ser-proac-forms">\
                <input type="text" class="form-control mt-1" name="contract-number" placeholder="Номер договора" required>\
                <input type="text" class="form-control mt-1" name="contract-date" placeholder="Дата договора" required>\
            </div>'
        );
    }
});
    ...
    if ($('#type-of-contract').val() == "Лицензионный договор"){
        $('#type-of-contract-forms').replaceWith(
            '<div class="mt-3" id="type-of-contract-forms">\
                <input type="text" class="form-control mt-1" name="date-of-conclusion" placeholder="Дата заключения" required>\
                <input type="text" class="form-control mt-1" name="number" placeholder="Номер" required>\
                <input type="text" class="form-control mt-1" name="date-of-registration" placeholder="Дата регистрации" required>\
                <input type="text" class="form-control mt-1" name="due-date" placeholder="Срок оплаты" required>\
                <input type="text" class="form-control mt-1" name="payment" placeholder="Оплата" required>\
                <input type="text" class="form-control mt-1" name="date-of-payment" placeholder="Дата оплаты" required>\
